...
| Name | Jessica Ni |
| NetID | dkh8my |
| DOI | [![DOI](https://zenodo.org/badge/1208252387.svg)](https://doi.org/10.5281/zenodo.19858394) |
...
| Pipeline | [Data Acquisition](load_and_prepare_data.ipynb) <br> [Problem Solution Pipeline Code](Problem_Solution_Pipeline.ipynb) <br> [Problem Solution Pipeline Markdown](Problem_Solution_Pipeline.md) |
